...
--
-- Servidor: localhost
-- Tiempo de generación: 08-09-2017 a las 05:36:27
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `listLocations` ()  BEGIN
    IF(SELECT EXISTS(SELECT * FROM location))THEN
		SELECT * FROM location WHERE id=18 OR id=19 OR id=20 OR id=22;
    ELSE
		SELECT 'yes' as error, 'Error, registro no encontrado' as response;
    END IF;
END$$
...
(22, -19.0156403, -65.2492993, 'Bosquecillo, ZONA CAL ORCKO', 'Av. Marcelo Quiroga Sta Cruz');
