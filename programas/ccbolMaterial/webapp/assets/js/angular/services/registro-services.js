...
var  urlServer ="localhost"; 
	...
	var self ={
		...
		printChecked : function(datos){
					var d = $q.defer();
					// console.log(datos);
                    $http({
                      method: 'GET',
					  	url: 'http://'+urlServer+'/ccbolAdmin/api/public/user/printChecked/'+datos
                    	})
                        .then(function successCallback(response) {
								// console.log(response.data);
								self.response 	= response.data;
		...
		material : function(datos){
					var d = $q.defer();
					console.log(datos);
                    $http({
                      method: 'GET',
					  	url: 'http://'+urlServer+'/ccbolAdmin/api/public/user/material/'+datos
                    	})
                        .then(function successCallback(response) {
								// console.log(response.data);
								self.response 	= response.data;
