...
class  UserModel
{
	...
	public function listUserBc($data){
		...
		if($res[0] == 'yes'){
			...
			if($res[1] == 1){
				$res = array("error"=>$res[0],"type"=>$res[1],"_name"=>$res[2],"_last_name"=>$res[3],"_ci"=>$res[4],"_email"=>$res[5],"_city"=>$res[6],"_college"=>$res[9] ,"_career"=>$res[10],"_id"=>$res[10],"_cargo"=>$res[7] ,"response"=>true);
			}else{
