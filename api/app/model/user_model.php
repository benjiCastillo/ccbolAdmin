...
class  UserModel
{
	...
	public function listUserBc($data){
		...
		if($res[0] == 'yes'){
			...
			if($res[1] == 1){
				$res = array("error"=>$res[0],"type"=>$res[1],"_name"=>$res[2],"_last_name"=>$res[3],"_ci"=>$res[4],"_email"=>$res[5],"_city"=>$res[6],"_college"=>$res[8] ,"_career"=>$res[9],"_id"=>$res[10],"_cargo"=>$res[11] ,"response"=>true);
			}else{
				$res = array("error"=>$res[0],"type"=>$res[1],"_name"=>$res[2],"_last_name"=>$res[3],"_ci"=>$res[4],"_email"=>$res[5],"_city"=>$res[6],"_professional_degree"=>$res[8],"_id"=>$res[9] ,"_cargo"=>$res[10],"response"=>true);
			}
		}
		return $res;		 
}
